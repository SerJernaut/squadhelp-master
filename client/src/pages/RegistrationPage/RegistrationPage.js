      ...
      <div className={ styles.footer }>
        <div className={ styles.articlesMainContainer }>
          <div className={ styles.ColumnContainer }>
            <div className={ styles.headerArticle }>Why should I use
              Squadhelp?
            </div>
            ...
            <div className={ styles.headerArticle }>How is Squadhelp
              Different?
            </div>
            <div className={ styles.article }>
          ...
          <div className={ styles.ColumnContainer }>
            <div className={ styles.headerArticle }>I’ve never used Squadhelp
            ...
            <div className={ styles.headerArticle }>Do you offer any discount
            ...
            <div className={ styles.headerArticle }>Will you help me validate my
              name?
            </div>
            <div className={ styles.article }>
            ...
            <div className={ styles.headerArticle }>I have other questions! How
